...
try {
    Register-ScheduledTask -TaskName "MuxivaCodexRelay" -Action $action -Trigger $trigger -Settings $settings -Description "Bluetooth relay for ESP32 Codex tasks" -Force -ErrorAction Stop | Out-Null
